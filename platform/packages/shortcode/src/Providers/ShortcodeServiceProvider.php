...
class ShortcodeServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        add_filter(BASE_FILTER_FORM_EDITOR_BUTTONS, function (string|null $buttons, array $attributes, string $id) {
            ...
            $buttons .= Blade::render(sprintf('
                <x-core::button
                    ...
                    data-result="%s"
                > %s </x-core::button>
            ', $id, trans('packages/shortcode::shortcode.ui-blocks')));
        ...
        add_filter(BASE_FILTER_FORM_EDITOR_BUTTONS_HEADER, function (string|null $header, array $attributes) {
            ...
            $header .= sprintf('<link rel="stylesheet" href="%s" />', asset('vendor/core/packages/shortcode/css/shortcode.css'));
