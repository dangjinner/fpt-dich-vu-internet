...
<div class="row price-group">
    ...
    <div class="col-md-4">
        ...
        >
            ...
            <x-slot:labelDescription>
                <a
                    @class(['turn-on-schedule', 'd-none' => old('sale_type', $product ? $product->sale_type : $originalProduct->sale_type ?? 0) == 1])
                    href="javascript:void(0)"
                >
                    {{ trans('plugins/ecommerce::products.form.choose_discount_period') }}
                </a>
                <a
                    @class(['turn-off-schedule', 'd-none' => old('sale_type', $product ? $product->sale_type : $originalProduct->sale_type ?? 0) == 0])
                    href="javascript:void(0)"
                >
    ...
    <div @class(['col-md-6 scheduled-time', 'd-none' => old('sale_type', $product ? $product->sale_type : $originalProduct->sale_type ?? 0) == 0])>
        <x-core::form.text-input
...
<x-core::form.fieldset @class(['storehouse-info', 'd-none' => old('with_storehouse_management', $product ? $product->with_storehouse_management : $originalProduct->with_storehouse_management ?? 0) == 0])>
    <x-core::form.text-input
...
<x-core::form.fieldset @class(['stock-status-wrapper', 'd-none' => old('with_storehouse_management', $product ? $product->with_storehouse_management : $originalProduct->with_storehouse_management ?? 0) == 1])>
